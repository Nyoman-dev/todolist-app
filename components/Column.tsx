...
export default function Column({
	...
	return (
		<div className='flex flex-col w-80 md:w-96 shrink-0 h-full max-h-full rounded-xl border border-zinc-200/60'>
			<div className='p-4 flex items-center justify-between sticky top-0'>
				<div className='flex items-center gap-2'>
					<div className={`w-2 h-2 rounded-full ${color} animate-ping`}></div>
